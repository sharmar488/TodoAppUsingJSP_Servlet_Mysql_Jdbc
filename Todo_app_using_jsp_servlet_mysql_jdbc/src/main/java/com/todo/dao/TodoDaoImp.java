...
public class TodoDaoImp implements TodoDao {
	...
	private static final String INSERT_TODOS_SQL = "INSERT INTO todos" +
	        "  (title, email, description, target_date,  is_done) VALUES " + " (?, ?, ?, ?, ?);";
	private static final String SELECT_TODO_BY_ID = "select id,title,email,description,target_date,is_done from todos where id =?";
	private static final String SELECT_ALL_TODOS = "select * from todos";
	private static final String DELETE_TODO_BY_ID = "delete from todos where id = ?;";
	private static final String UPDATE_TODO = "update todos set title = ?, email= ?, description =?, target_date =?, is_done = ? where id = ?;";
